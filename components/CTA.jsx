  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Book a free 45-minute technical discovery call with one of our engineers. No sales
          decks — just honest conversations about your challenges.
        </p>
        <div
          style={{
            display: 'flex',
        ...
        >
          ...
          <a
            href="mailto:hello@tbnnetwork.co.uk"
            style={{
              color: '#64748B',
              fontFamily: 'monospace',
              fontSize: 15,
